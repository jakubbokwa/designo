...
const CallToAction = () => {
  return (
    <div className="overflow-hidden relative bg-primary-peach rounded-2xl mx-6 md:mx-10 lg:mx-41 xl:mx-auto xl:max-w-[1111px] text-white text-center top-[189px]">
      ...
      <div className="relative mx-6 lg:mx-24 py-16 lg:py-0 flex flex-col lg:flex-row items-center z-20">
        <div className="flex flex-col items-center lg:items-start lg:my-12 xl:my-16">
          <h2 className="text-4xl-mobile md:text-4xl font-medium mx-6 md:w-7/12 lg:w-3/4 xl:w-7/12 lg:mx-0 lg:text-left mb-4">
